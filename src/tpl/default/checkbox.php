<div class="mt-2">
    ...
    <div>
        ...
        <div class="form-check {if isset($inline) && $inline} form-check-inline{/if}">
            ...
            <input type="checkbox" class="form-check-input" id="{$id}_{:md5($_vo)}" name="{$name}[]" value="{$_vo}" checked>
            {else}
            <input type="checkbox" class="form-check-input" id="{$id}_{:md5($_vo)}" name="{$name}[]" value="{$_vo}">
            {/if}
